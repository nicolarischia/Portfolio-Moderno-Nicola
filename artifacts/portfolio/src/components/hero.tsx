...
export function Hero() {
  return (
    <section id="home" className="min-h-[100dvh] flex flex-col justify-center relative pt-20 pb-20 overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-foreground leading-[1.1] mb-8 drop-shadow-lg">
            Costruisco esperienze <br className="hidden md:block" />
