...
const ALL_RESULTS: SearchResult[] = [
  ...
  },
  {
    ...
    icon: <Hash className="h-4 w-4" />,
    keywords: "competenze skills tecnologie strumenti",
  },
  {
    id: "sec-projects",
    category: "Sezioni",
    ...
    icon: <Hash className="h-4 w-4" />,
    keywords: "progetti projects portfolio lavori",
  },
  {
    id: "sec-experience",
    category: "Sezioni",
    ...
    icon: <Hash className="h-4 w-4" />,
    keywords: "formazione esperienza education diploma studio",
  },
  {
    id: "sec-contact",
    category: "Sezioni",
    ...
    icon: <Hash className="h-4 w-4" />,
    keywords: "contatti contact email whatsapp",
  },
  ...
  },
  {
    ...
    category: "Competenze",
    title: "Python",
    subtitle: "Linguaggio di programmazione",
    action: () => document.getElementById("skills")?.scrollIntoView({ behavior: "smooth" }),
    icon: <Code2 className="h-4 w-4" />,
    keywords: "python programmazione",
  },
  {
    id: "sk-figma",
    category: "Competenze",
  ...
  },
  {
    ...
    category: "Competenze",
    title: "Git",
    subtitle: "Controllo versione",
    action: () => document.getElementById("skills")?.scrollIntoView({ behavior: "smooth" }),
    icon: <Code2 className="h-4 w-4" />,
    keywords: "git versione controllo",
  },
  ...
  // Progetti
  {
    ...
    keywords: "piattaforma gestione dati sport react nodejs mongodb backend",
  },
  {
    id: "pr-gioielleria",
    category: "Progetti",
    ...
    icon: <ArrowRight className="h-4 w-4" />,
    keywords: "gioielleria avorio wix sito vetrina jewelry",
  },
  {
    id: "pr-showcase",
    category: "Progetti",
    ...
    icon: <ArrowRight className="h-4 w-4" />,
    keywords: "interfaccia showcase frontend react css bootstrap",
  },
  ...
  // Formazione
  {
    ...
    keywords: "diploma perito informatico terni scuola istituto",
  },
  {
    id: "ed-react",
    category: "Formazione",
    title: "React Avanzato & Architetture Frontend",
    subtitle: "Studio autonomo · 2023–2024",
    action: () => document.getElementById("experience")?.scrollIntoView({ behavior: "smooth" }),
    icon: <GraduationCap className="h-4 w-4" />,
    keywords: "react avanzato frontend architettura corso",
  },
  {
    id: "ed-freecodecamp",
    category: "Formazione",
    ...
    action: () => document.getElementById("experience")?.scrollIntoView({ behavior: "smooth" }),
    icon: <GraduationCap className="h-4 w-4" />,
    keywords: "algoritmi strutture dati javascript freecodecamp",
  },
  ...
  // Contatti
  {
    ...
    keywords: "email contatto scrivi gmail",
  },
  {
    id: "ct-github",
    category: "Contatti",
    ...
    icon: <ArrowRight className="h-4 w-4" />,
    keywords: "github repository codice profilo",
  },
  {
    id: "ct-linkedin",
    category: "Contatti",
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-[#0a0a0a] border border-white/15 rounded-2xl shadow-2xl shadow-primary/10 overflow-hidden">
              {/* Search input */}
              <div className="flex items-center gap-3 px-4 py-4 border-b border-white/10">
                ...
                <kbd className="hidden sm:flex items-center px-2 py-1 bg-white/8 border border-white/10 rounded text-xs text-white/40 font-mono">
                  esc
                </kbd>
              </div>
              ...
              <div ref={listRef} className="max-h-[60vh] overflow-y-auto py-2 no-scrollbar">
                {flat.length === 0 ? (
                  ...
                  Object.entries(grouped).map(([category, items]) => {
                    return (
                      <div key={category}>
                        <div className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground/60">
                          {category}
                        </div>
                        {items.map((item) => {
              ...
              {/* Footer hint */}
              <div className="px-4 py-3 border-t border-white/10 flex items-center gap-4 text-[11px] text-muted-foreground/50">
